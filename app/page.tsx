    ...
    <div className="reel-modal-backdrop" onClick={onClose}>
      <div className="reel-modal" onClick={e => e.stopPropagation()}>
        ...
        <div className="reel-modal-stats">
          <div className="reel-modal-stat">
            <span className="reel-modal-stat-num">{reel.views}</span>
            <span className="reel-modal-stat-lbl">Views</span>
          </div>
          <div className="reel-modal-stat">
            <span className="reel-modal-stat-num">{reel.likes}</span>
            <span className="reel-modal-stat-lbl">Likes</span>
          </div>
          <div className="reel-modal-stat">
            <span className="reel-modal-stat-num">{reel.comments}</span>
            <span className="reel-modal-stat-lbl">Comments</span>
          </div>
        </div>
      </div>
    </div>
...
// ─── Hero Reel Card ───────────────────────────────────────────────────────────
function HeroReelCard({ reel, isCenter, onClick }: { reel: ReelData; isCenter?: boolean; onClick: () => void }) {
  return (
    <div
...
// ─── Main Page ────────────────────────────────────────────────────────────────
export default function ViralishHomepage() {
  ...
  return (
    <>
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Montserrat:wght@400;500;600;700;800;900&family=Dancing+Script:wght@700&display=swap');
        @import url('https://fonts.googleapis.com/css2?family=Barlow+Condensed:wght@900&family=Dancing+Script:wght@700&family=Montserrat:wght@400;500;600;700;800;900&display=swap');
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .mobile-menu {
          ...
          background: var(--darkest); z-index: 99;
        ...
        .hero {
          ...
          padding-top: 110px; text-align: center; position: relative; overflow: hidden; background: #0a0a0a;
        }
        .hero-bg {
        ...
        .hero-badge {
          ...
          color: rgba(255,255,255,0.85); margin-bottom: 28px; backdrop-filter: blur(8px);
        }
  ...
  text-shadow: 0 2px 20px rgba(0,0,0,0.4);
        ...
        .hero-cursive-row {
          width: 100%; max-width: 900px; display: flex; justify-content: flex-end;
          padding-right: 24px; margin-top: 4px; margin-bottom: 40px;
        }
        ...
        .btn-hero-red {
          background: var(--red); color: var(--white); padding: 0 40px; height: 72px;
          display: flex; flex-direction: column; align-items: center; justify-content: center;
          border: none; cursor: pointer; text-decoration: none; transition: all 0.25s; border-radius: 4px; min-width: 260px;
        }
        ...
        .btn-hero-dark {
          background: rgba(40,40,40,0.92); color: var(--white); padding: 0 40px; height: 72px;
          display: flex; flex-direction: column; align-items: center; justify-content: center;
          border: 1px solid rgba(255,255,255,0.12); cursor: pointer; text-decoration: none;
          transition: all 0.25s; border-radius: 4px; min-width: 260px; backdrop-filter: blur(8px);
        }
        ...
        /* ── HERO REELS ROW ── */
        .hero-reels-wrap { width: 100%; position: relative; z-index: 2; margin-top: 0; }
        .hero-reels-annotation {
          position: absolute; left: calc(21% + 8px); top: 52px;
          display: flex; flex-direction: column; align-items: flex-start; z-index: 10; pointer-events: none;
        }
        ...
        .hero-reels-scroll { display: flex; gap: 30px; padding: 40px 0 0 0; align-items: flex-end; width: 100%; overflow: hidden; }

        .reel-card {
          flex: 1; min-width: 0; aspect-ratio: 9/16; position: relative;
        ...
        .reel-card--center { flex: 1.35; margin-top: -60px; border-radius: 20px; z-index: 2; box-shadow: 0 24px 80px rgba(0,0,0,0.7); }
        .reel-card--center:hover { transform: translateY(-8px) scale(1.02); }
        .reel-card:first-child { border-radius: 0 18px 18px 0; margin-left: -60px; }
        .reel-card:last-child { border-radius: 18px 0 0 18px; margin-right: -60px; }
        .reel-card-overlay {
          position: absolute; inset: 0; background: rgba(0,0,0,0);
          display: flex; align-items: center; justify-content: center;
          transition: background 0.25s ease; z-index: 3;
        }
        ...
        .reel-play-btn {
          ...
          display: flex; align-items: center; justify-content: center; font-size: 20px; color: #111;
          opacity: 0; transform: scale(0.7); transition: opacity 0.25s ease, transform 0.25s ease; padding-left: 4px;
        }
        ...
        .reel-modal {
          width: min(380px, 92vw); background: #111; border-radius: 20px; overflow: hidden;
          box-shadow: 0 40px 120px rgba(0,0,0,0.9);
          animation: slideUp 0.28s cubic-bezier(0.34,1.56,0.64,1); position: relative;
        }
        @keyframes slideUp { from { opacity: 0; transform: translateY(40px) scale(0.95); } to { opacity: 1; transform: translateY(0) scale(1); } }
        .reel-modal-close {
          position: absolute; top: 12px; right: 12px; z-index: 10;
          width: 36px; height: 36px; border-radius: 50%; background: rgba(232,0,11,0.9);
        ...
        .reel-modal-stats {
          display: grid; grid-template-columns: repeat(3, 1fr); padding: 20px 0;
          border-top: 1px solid rgba(255,255,255,0.08); background: #111;
        }
        ...
        /* ── LOGO STRIP ── */
        .logo-strip { width: 100%; overflow: hidden; background: rgba(0,0,0,0.88); padding: 32px 0; position: relative; z-index: 3; margin-top: -2px; }
        ...
        /* ── SERVICES ── */
        .services-header {
          max-width: 1300px; margin: 0 auto; padding: 80px 60px 48px;
          display: flex; align-items: flex-end; justify-content: space-between; gap: 40px;
        }
        .services-header-left { flex: 1; }
        .services-main-title {
          font-family: 'Montserrat', sans-serif; font-weight: 900;
          font-size: clamp(28px, 4vw, 58px); line-height: 1.05;
          text-transform: uppercase; color: var(--white); margin-bottom: 20px; letter-spacing: -0.5px;
        }
        .services-viral-word { position: relative; display: inline-block; color: var(--red); }
        .services-viral-oval {
          position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);
          width: 115%; height: 140%; pointer-events: none;
        }
        .services-subtitle { font-size: 16px; color: rgba(255,255,255,0.65); font-weight: 400; line-height: 1.5; }
        .btn-services-cta {
          background: var(--red); color: var(--white); font-size: 14px; font-weight: 700;
          letter-spacing: 1px; text-transform: uppercase; padding: 18px 48px;
          border: none; cursor: pointer; text-decoration: none; transition: all 0.25s; white-space: nowrap; flex-shrink: 0;
        }
        ...
        /* Card is a single box — video fills it, content overlays at bottom */
        .service-video-card {
          position: relative;
          border-radius: 14px;
          overflow: hidden;
        ...
        .service-video-card:hover .service-video-overlay {
          background: linear-gradient(to bottom, rgba(0,0,0,0) 20%, rgba(0,0,0,0.92) 65%, rgba(0,0,0,0.97) 100%);
        }
        ...
        /* Gradient overlay — heavier at bottom where text sits */
        .service-video-overlay {
          position: absolute; inset: 0; z-index: 2;
          background: linear-gradient(to bottom, rgba(0,0,0,0) 25%, rgba(0,0,0,0.88) 65%, rgba(0,0,0,0.95) 100%);
          transition: background 0.3s;
        }

        /* Content sits at bottom of the card, on top of overlay */
        ...
        .service-video-title {
          font-family: 'Montserrat', sans-serif; font-weight: 900;
          font-size: clamp(18px, 2.2vw, 26px); letter-spacing: 1px;
          text-transform: uppercase; color: var(--white);
          text-shadow: 0 2px 12px rgba(0,0,0,0.8);
        }
        .service-video-desc {
          font-size: 15px; color: rgba(255,255,255,0.88); line-height: 1.55;
          max-width: 360px; text-shadow: 0 1px 8px rgba(0,0,0,0.9);
        }
        ...
        .btn-service-video {
          ...
          text-align: center; text-decoration: none; transition: background 0.25s;
        }
        ...
        .result-card {
          ...
          padding: 32px 24px; text-align: center; cursor: pointer; transition: all 0.3s; position: relative; overflow: hidden;
        }
        ...
        .founder-image-placeholder {
          width: 100%; aspect-ratio: 1; background: linear-gradient(135deg, #1a0a0a, #2a0808);
          border: 1px solid rgba(232,0,11,0.2); display: flex; align-items: center; justify-content: center;
        ...
        .btn-outline {
          background: transparent; color: var(--white); font-size: 13px; font-weight: 700;
          letter-spacing: 1.5px; text-transform: uppercase; padding: 14px 34px;
          border: 2px solid rgba(255,255,255,0.4); cursor: pointer; text-decoration: none; transition: all 0.25s;
          clip-path: polygon(8px 0%, 100% 0%, calc(100% - 8px) 100%, 0% 100%); display: inline-block;
        }
...
/* override reel-play-btn so it's always white, not hidden by default */
.service-video-card .reel-play-btn {
  ...
  font-size: 22px !important;
      ...
      <nav className="navbar">
        <a href="#" className="nav-logo">
          <span className="nav-logo-text">
            viral<span className="accent">i</span>sh
          </span>
        </a>
        ...
        <div className="hero-content">
          ...
          <div className="hero-cursive-row">
            <span className="hero-cursive">
              ...
              >
                <path
                  d="M2 4C6 2 14 6 12 14C10 20 4 22 8 26"
                  stroke="white"
                  strokeWidth="1.8"
                  strokeLinecap="round"
                  fill="none"
          ...
          <div className="hero-ctas">
            <a href="#services" className="btn-hero-red">
              ...
              <span className="btn-hero-red-sub">
                For Entrepreneurs or Big Brands
              </span>
            </a>
          ...
          <div className="hero-reels-wrap">
            <div className="hero-reels-annotation">
              ...
              <svg width="44" height="40" viewBox="0 0 44 40" fill="none">
                <path
                  d="M8 4C14 2 22 10 18 22C15 30 4 32 8 38"
                  stroke="white"
                  strokeWidth="1.8"
                  strokeLinecap="round"
                  fill="none"
      ...
      <section id="services" style={{ background: "var(--darkest)" }}>
        <div className="services-header">
          ...
          <a href="#" className="btn-services-cta">
            Work With Us
          </a>
        </div>
        ...
        <div className="services-cards">
          ...
          >
            ...
            <div className="service-video-content">
              ...
              <p className="service-video-desc">
                We help your brand get more attention so you can get more sales.
              </p>
              {/* <a
                href="#"
                className="btn-service-video"
          ...
          >
            ...
            <div className="service-video-content ">
              ...
              <p className="service-video-desc">
                We integrate <strong>Big Brands</strong> into cultural relevance
                at scale.
              </p>
              {/* <a
                href="#"
